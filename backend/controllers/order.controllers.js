        ...
        if (io) {
            for (const shopOrder of newOrder.shopOrders) {
                ...
                if (owner?.socketId) {
                    ...
                    console.log(" Owner socketId missing");
                }
            }
        }
...
export const acceptOrder = async (req, res) => {
    try {
        ...
        if (io && updatedShopOrder) {
            const ownerId = updatedShopOrder.owner?._id || updatedShopOrder.owner;
            ...
            if (owner?.socketId) {
                io.to(owner.socketId).emit("delivery-boy-assigned", {
                    ...
                    shopOrderId: updatedShopOrder._id,
                    deliveryBoy: {
                        fullName: updatedShopOrder.assignedDeliveryBoy?.fullName,
                        mobile: updatedShopOrder.assignedDeliveryBoy?.mobile
                    }
                });
            }
        }
...
export const verifyDeliveryOtp = async (req, res) => {
    try {
        ...
        const updatedShopOrder = order.shopOrders.id(shopOrder._id);
